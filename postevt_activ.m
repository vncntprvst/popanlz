function [ratios,errorActivLatency,pvals]=postevt_activ
% "Performance monitoring"
% find error- or cancellation-related activity and latency of such activity
...
%             prevssd=mode(allSSDs(uniqSSDsIdx==SSDnum));
            ...
            % Keep all trials for now
            alignedata=gsdata.allndata{recNum, 1};
...
%             plot(sdf{2});
            ...
            %% find delay of differential activity (if there's a difference)
...
%             end
            ...
            threshold=gsdata.bslThd{recNum, 1};
            nanmean(diff_sdf(1:alignidx-start))+nanstd(diff_sdf(1:alignidx-start)); 
